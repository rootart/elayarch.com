...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('portfolio_portfolioitem', 'position', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortfolioItem.position'
        db.delete_column('portfolio_portfolioitem', 'position')
