...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('portfolio_portfolioitem', 'pub_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'PortfolioItem.pub_date'
        db.alter_column('portfolio_portfolioitem', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
